            ...
            UiStateOnboardingScreenState.Idle -> {
                DefaultMonoBg(
                    ...
                    Column(
                        ...
                        if (uiState.currentPage > 0) {
                            Row(
                                ...
                                SizeAnimationInvisible(
                                    isVisible = uiState.currentPage > 0 && currentRoute !in disablePrevPageRoutes,
                                    clickEnabled = uiState.currentPage > 0 && currentRoute !in disablePrevPageRoutes
                                ) {
                                    Icon(
                        ...
                        BackHandler(enabled = currentRoute in disablePrevPageRoutes) {
